...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/meanmenu.min.css')}}">
        ...
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/themify-icons.css')}}">
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/flaticon.css')}}">
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/twentytwenty.css')}}">
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/nice-select.css')}}">
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/jquery.fancybox.min.css')}}">
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/vendors/jquery.nstSlider.min.css')}}">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="tm-preloader-logo">
                    <img src="{{ asset('frontend/assets/images/loder.gif')}}" alt="logo">
                </div>
            </div>
        </div>
    </div>
...
<!--// Wrapper -->
    ...
    <script src="{{ asset('frontend/assets/js/vendors/jquery.twentytwenty.js')}}"></script>
    ...
    <script src="{{ asset('frontend/assets/js/vendors/jquery.ajaxchimp.min.js')}}"></script>
    <script src="{{ asset('frontend/assets/js/vendors/jquery.fancybox.min.js')}}"></script>
    <script src="{{ asset('frontend/assets/js/vendors/instafeed.min.js')}}"></script>

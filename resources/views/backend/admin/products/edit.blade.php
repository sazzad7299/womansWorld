                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-outline-primary text-end" href="{{ route('admin.products.index') }}"
                            >{{ __('All Product') }}</a>
                       </div>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            required="" class="js-example-basic-single form-select" data-width="100%">
                                                @foreach ($indentedCategories as $categoryId => $categoryName)
                                                    <option value="{{ $categoryId }}" {{$categoryId==$products->category_id ? 'selected':''}}>{{ html_entity_decode($categoryName) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Sell Price') }}" autocomplete="off" name="price"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Purchase Price') }}" autocomplete="off" name="old_price"
                                                value="{{ old('old_price', $products->old_price) }}" id="old_price" required />
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label" for="stock">{{ __('Quantity') }}</label>
                                            <input type="text" class="form-control"
                                                placeholder="{{ __('Quantity') }}" autocomplete="off" name="stock"
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label"
                                                ...
                                                <select name="discount_type" id="discount_type" class="form-control">
                                                    <option value="0" @if($products->discount_type==0) selected @endif>Discount Type</option>
                                                    <option value="2" @if($products->discount_type==2) selected @endif>Percent</option>
                                                    <option value="1" @if($products->discount_type==1) selected @endif>Regular</option>
                                                </select>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class=" form-select" data-width="100%"
                                                ...
                                                @foreach (getStatus() as $status)
                                                    <option value="{{ $status['value'] }}" {{$products->status == $status['value'] ? 'selected':''}}>{{ $status['label'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card" style="margin-top: 28px">
                                        ...
                                        <div class="card-body">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" name="featured" {{$products->featured ==1 ? 'checked' : ''}}>
                                                <label class="form-check-label" for="flexCheckDefault">
                                                  Featured
                                                </label>
                                              </div>
                                              <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" name="p_set" {{$products->p_set ==1 ? 'checked' : ''}}>
                                                <label class="form-check-label" for="flexCheckChecked">
                                                  Perfume Set
                                                </label>
                                              </div>
                                              <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" name="new" {{$products->new ==1 ? 'checked' : ''}}>
                                                <label class="form-check-label" for="flexCheckChecked">
                                                  New Arrival
                                                </label>
                                              </div>
                                    ...
                                    <div class="card" style="margin-top: 28px">
                                        ...
                                        <div class="card-body">
                                            <center>
                                                <img src="{{ asset($products->display) }}" id="product-photo" width="100px">

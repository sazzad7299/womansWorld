            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-primary float-end" data-toggle="modal" data-target="#create" href="">{{ __('New General') }}</a>
                        </div>
                                    ...
                                    @foreach ($generals as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.generals.destroy', [$item->id]) }}"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title h4" id="myExtraLargeModalLabel">{{ __('New General') }}
                                        </h5>
                                    ...
                                    <div class="modal-body">
                                        <form class="forms-sample" method="POST"
                                            action="{{ route('admin.generals.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="{{ __('Value') }}"
                                                        autocomplete="off" name="value" value="{{ old('value') }}"
                                                        required="" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
...
@section('footer')
    <script>
        $('#edit').on("show.bs.modal", function(event) {
            ...
            let action = '{{ URL::to('admin/generals/update') }}';

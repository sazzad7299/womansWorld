                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <h6 class="card-title">{{ __('Size') }}</h6>
                        <a class="btn btn-outline-primary float-end" data-toggle="modal" data-target="#create" href="">{{ __('New Size') }}</a>
                        </div>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title h4" id="myExtraLargeModalLabel">{{ __('New Size') }}</h5>
                                    ...
                                    <div class="modal-body">
                                        <form class="forms-sample" method="POST"
                                            action="{{ route('admin.sizes.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-3">
                        ...
                        <div class="modal fade bd-example-modal-xl" tabindex="-1" aria-labelledby="myExtraLargeModalLabel"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title h4" id="myExtraLargeModalLabel">{{ __('Update Size') }}
                                        </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
...
@section('footer')
    <script>
        $('#edit').on("show.bs.modal", function(event) {
            ...
            let action = '{{ URL::to('admin/sizes/update') }}';

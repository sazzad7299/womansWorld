        ...
        stickyHeader: function () {
            if ($('.tm-header-sticky').exists()) {
                ...
                $(window).on('scroll ,resize', function () {
                    var win = $(this);
                    if (win.scrollTop() > 250 && win.width()>= 1311) {
                        $('.tm-header').addClass('is-sticky');
                        $('.tm-header-sticky-logo').removeClass('d-none');
                        $('.tm-header-sticky-icons').removeClass('d-none');
                    } else {
                        $('.tm-header').removeClass('is-sticky');
                        $('.tm-header-sticky-logo').addClass('d-none');
                        $('.tm-header-sticky-icons').addClass('d-none');
                    }
                    if (win.width() <= 1310) {
                        $('.tm-header-sticky-logo').removeClass('d-none');
                        $('.tm-header-sticky-icons').removeClass('d-none');
                        $('.tm-header-toparea').addClass('d-none');
                        $('.tm-header-icons').css({'margin-right':'20px'});
